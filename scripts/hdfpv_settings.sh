...
HDFPV_MSP_FIFO="${HDFPV_DIR}/mspfifo1"
HDFPV_TELEMETRY_FIFO="${HDFPV_DIR}/telemetryfifo"
...
HDFPV_VIDEO_FIFO="${HDFPV_DIR}/videofifo"
...
HDFPV_WBC_STATUS="${HDFPV_DIR}/wbc_status"
HDFPV_TX="${HDFPV_DIR}/tx"
HDFPV_RX="${HDFPV_DIR}/rx"
HDFPV_FTEE="${HDFPV_DIR}/ftee"

HDFPV_RCRX="${HDFPV_DIR}/rcrx"
HDFPV_RSSITX="${HDFPV_DIR}/rssitx"
HDFPV_RSSIRX="${HDFPV_DIR}/rssirx"
HDFPV_RASPI2PNG="${HDFPV_DIR}/raspi2png"
HDFPV_RSSI_FORWARD="${HDFPV_DIR}/rssi_forward"
HDFPV_CHANNELSCAN="${HDFPV_DIR}/channelscan"
HDFPV_TRACKER="${HDFPV_DIR}/tracker"
HDFPV_CHECK_ALIVE="${HDFPV_DIR}/check_alive"
...
WIFIBROADCAST_CONF_TMP="/tmp/settings.sh"
